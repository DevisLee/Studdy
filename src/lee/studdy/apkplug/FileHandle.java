...
public class FileHandle {
	 ...
	 * 根路径
	 */
	public void start(Vector list,FilenameFilter filter){
		loadFiles(list,rootDir,filter);
	}
	public void start(Vector list,String dirpath,FilenameFilter filter){
